 ...
 */
typedef NS_ENUM(NSUInteger, OMIStunUse) {
    /**
     ...
     * transport.
     */
    OMIStunUseRetryOnFailure = 2
};

/**
 *  Enum which specifies the contact rewrite method
 */
typedef NS_ENUM(NSUInteger, OMIContactRewriteMethod) {
    /**
     ...
     */
    OMIContactRewriteMethodUnregister = 1,
    /**
     ...
     */
    OMIContactRewriteMethodNoUnregister = 2,
    /**
    ...
    OMIContactRewriteMethodAlwaysUpdate = 4
};

@interface OMIAccountConfiguration : NSObject
...
@property (strong, nonatomic) NSString * _Nonnull transportType;
...
@property (readonly, nonatomic) NSString * _Nonnull sipAddressType2;
 ...
 */
@property (nonatomic) int sipStunType;

/**
 *  The media stun type that should be used.
 */
@property (nonatomic) int mediaStunType;
 ...
 */
@property (nonatomic) OMIContactRewriteMethod contactRewriteMethod;
